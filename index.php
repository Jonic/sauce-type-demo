<?php $fonts = 'https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,300;0,400;0,500;0,700;1,400&display=swap'; ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
    ...
    <meta name="author" content="The Raspberry Pi Foundation" />
    ...
    <meta property="og:image" content="https://www.raspberrypi.org/homepage-9df4b/images/default-opengraph.png" />
    <meta property="og:site_name" content="Raspberry Pi" />
    <meta property="og:title" content="Teach, Learn, and Make with Raspberry Pi – Raspberry Pi" />
    <meta property="og:type" content="website" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:creator" content="Raspberry Pi" />
    <meta name="twitter:site" content="Raspberry Pi" />

    <link as="style" href="<?= $fonts ?>" rel="preload" />
    <link href="<?= $fonts ?>" media="print" onload="this.media='all'" rel="stylesheet" />
    <noscript><link href="<?= $fonts ?>" rel="stylesheet" /></noscript>

    <link rel="stylesheet" href="/assets/css/sauce.min.css" />
    <link rel="icon" href="https://www.raspberrypi.org/homepage-9df4b/favicon.png" />

    <title>Teach, Learn, and Make with Raspberry Pi</title>
  ...
  <body>
    <div class="wrapper" style="max-width: 1300px; margin">
      ...
      <aside id="styles">
        <div class="container">
          ...
          <ul class="features">
            ...
            <li>
              <span>
                <a href="/styles/blueprint">Blueprint<span aria-hidden="true"></span></a>
